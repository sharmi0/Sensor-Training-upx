...
while True:
    ...
    # print it out
    print("\033c", end="")
    print("%5.2f, %8.0f, %8.0f, %8.0f, %8.0f, %8.0f, %8.0f, %8.0f, %8.0f" % (flt_data[0], flt_data[4], flt_data[5], flt_data[6], flt_data[7], flt_data[8], flt_data[9], flt_data[10], flt_data[11]))
    # print(flt_data[0:4])