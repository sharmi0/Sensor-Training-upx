...
# trajectory filename
trajectory_filename = 'trajectories/ellipsoid_newgantry_training.csv'
# traj_speed = 25.0
        ...
        for command in self.commands:
            ...
            while 1:
                ...
                if np.all(self.position_diff < 10):
                    ...
                    if time.time() - beforepos_time > 1.5:
            ...
            self.groupSyncRead.clearParam()
            j = j+1
    '''collect ati data, time duration and time interval are both in seconds'''
    def ati_collect_data(self, time_duration, time_interval):
        # run through the gcodes in order
...
if __name__ == "__main__":
    ...
    robot.ati_collect_data(1200,0.1)
    robot.shutdown()